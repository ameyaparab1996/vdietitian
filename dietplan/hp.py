...
def hplc(conn, min_cal, max_cal, pref, med_hist):
    """
    ...
    diet_name = "High Protein Low Carbs Diet"
    print("High Protein Low Carbs Diet")
    ...
    print ('\nDinner')
    meal_type = 'Dinner'
    dinner = ['Spinach (Boiled)','Brocolli','Cauliflower','Lettuce','Cabbage','Green Peas','Soybeans','Paneer','Vegetables','Salmon','Mackerel','Chicken','Chicken Breast','Indian Chicken','Beans (Baked)','Egg Bhurji']
    if pref == 1:
...
def main(user_calorieintake):
    ...
    with conn:
        ...
        meals = hplc(conn,min_cal,max_cal,pref,med_hist)
        print("************Done Executing HPLC script! returning the plan\n")
        return meals
